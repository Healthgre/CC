...
class Test_008_transfers_V:
    def test_008_transfers_V(self, driver, auth, logout_after_test):
        ...
        """Проверка отображения страницы пользователя."""
        ...
        """Проверка перехода со страницы пользователя на главную страницу."""
        ...
        """Проверка перехода со страницы пользователя на страницу апгрейда."""
        ...
        """Проверка перехода со страницы пользователя на страницу контракта."""
        driver.find_element(By.XPATH,
        ...
        """Проверка перехода со страницы пользователя на страницу пополнения счёта."""
        ...
        """Проверка перехода со страницы пользователя на страницу пользовательского соглашения"""
        ...
        """Проверка перехода со страницы пользователя на страницу Вопрос - Ответ."""
